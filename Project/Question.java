public class Question {
   ...
   public void setOptions4(String options4) {
    ...
    public String toString() {
        ...
        sb.append(", options1=").append(options1);
        sb.append(", options2=").append(options2);
        sb.append(", options3=").append(options3);
        sb.append(", options4=").append(options4);
        sb.append(", answare=").append(answare);
        sb.append('}');
        return sb.toString();
    }
